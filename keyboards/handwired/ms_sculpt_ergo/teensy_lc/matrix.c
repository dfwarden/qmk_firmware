 ...
 * Matrix Col:  A   B   C   D   E   F   G   H   I   J   K   L   M   N   O   P   Q   R
 * Teensy Pin:  5   4   3   2   1   0  26  15  16  17  18  19  20  25  21  24  22  23 
 */
static void  init_cols(void)
{
    // internal pull-up
...
static matrix_row_t read_cols(void)
{
    return ((palReadPad(TEENSY_PIN5_IOPORT, TEENSY_PIN5)==PAL_HIGH) ? 0 : (1<<0)) |
           ((palReadPad(TEENSY_PIN4_IOPORT, TEENSY_PIN4)==PAL_HIGH) ? 0 : (1<<1)) |
           ((palReadPad(TEENSY_PIN3_IOPORT, TEENSY_PIN3)==PAL_HIGH) ? 0 : (1<<2)) |
           ((palReadPad(TEENSY_PIN2_IOPORT, TEENSY_PIN2)==PAL_HIGH) ? 0 : (1<<3)) |
           ((palReadPad(TEENSY_PIN1_IOPORT, TEENSY_PIN1)==PAL_HIGH) ? 0 : (1<<4)) |
           ((palReadPad(TEENSY_PIN0_IOPORT, TEENSY_PIN0)==PAL_HIGH) ? 0 : (1<<5)) |
           ((palReadPad(TEENSY_PIN26_IOPORT, TEENSY_PIN26)==PAL_HIGH) ? 0 : (1<<6)) |
           ((palReadPad(TEENSY_PIN15_IOPORT, TEENSY_PIN15)==PAL_HIGH) ? 0 : (1<<7)) |
           ((palReadPad(TEENSY_PIN16_IOPORT, TEENSY_PIN16)==PAL_HIGH) ? 0 : (1<<8)) |
           ((palReadPad(TEENSY_PIN17_IOPORT, TEENSY_PIN17)==PAL_HIGH) ? 0 : (1<<9)) |
           ...
           ((palReadPad(TEENSY_PIN25_IOPORT, TEENSY_PIN25)==PAL_HIGH) ? 0 : (1<<13)) |
           ((palReadPad(TEENSY_PIN21_IOPORT, TEENSY_PIN21)==PAL_HIGH) ? 0 : (1<<14)) |
           ((palReadPad(TEENSY_PIN24_IOPORT, TEENSY_PIN24)==PAL_HIGH) ? 0 : (1UL<<15)) |
           ((palReadPad(TEENSY_PIN22_IOPORT, TEENSY_PIN22)==PAL_HIGH) ? 0 : (1UL<<16)) |
           ((palReadPad(TEENSY_PIN23_IOPORT, TEENSY_PIN23)==PAL_HIGH) ? 0 : (1UL<<17));
}

/* Row pin configuration
 *
 * Matrix Row:  1  2  3  4  5  6  7  8
 * Teensy Pin: 13 12 11 10  9  8  7  6
 */
static void unselect_rows(void)
{
    // set pins to hi-Z / floating
